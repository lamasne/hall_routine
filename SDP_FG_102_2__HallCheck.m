...
load('calcul_fourier_SDP_FG_102(2)_2018_9_26_15_26__filtrat')
...
figure(10)
Line = 143;
plot(xj2(end/2+9:end,1),Jy2(end/2+9:end,Line),'rs'); hold on;
plot(xj2(1:end/2+9,1),Jy2(1:end/2+9,Line),'go');
plot(xj2(:,1),Jy2(:,Line),'b-');
JxcPos=trapz(xj2(end/2+9:end,1),Jy2(end/2+9:end,Line));
JxcNeg=trapz(xj2(1:end/2+9,1),Jy2(1:end/2+9,Line));
